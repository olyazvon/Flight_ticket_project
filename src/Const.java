public class Const {
    public static final String  AIRPORT_TABLE="Administrator.airports";
    ...
    public static final String  FLIGHT_TABLE="Administrator.flights";
    ...
    public static final String  BOOKING_TABLE="Administrator.Bookings";
    ...
    public static final String  USER_TABLE="Administrator.USERS";
    ...
    public static final String  PASSENGER_TABLE="Administrator.PASSENGERS";
    ...
    public static final String  SEAT_TABLE="Administrator.seats";
